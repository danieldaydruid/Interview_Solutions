namespace StockDataNamespace {
    ...
    public partial class StockData { public static StockData FromJson(string json) => JsonConvert.DeserializeObject<StockData>(json, StockDataNamespace.Converter.Settings); }
    public static class Serialize { public static string ToJson(this StockData self) => JsonConvert.SerializeObject(self, StockDataNamespace.Converter.Settings); }
